...
export default function Projects() {
  return (
    <div>
      ...
      <article className="md:w-[1200px] md:mt-20 w-[380px] mx-auto  text-black box-border">
        ...
        {work.slice(0,5).map((item, index) => {
          return (
            ...
            <figure
  key={index}
  className="relative group mb-8 bg-gray-200 dark:bg-[#18224b] cursor-pointer rounded-lg w-full md:w-full flex items-center md:h-[600px] sticky top-28 overflow-hidden shadow-lg"
>
  <img
    src={item.image}
    alt={item.title}
    className="w-[1100px] mx-auto group-hover:scale-105 transition-transform ease-in-out duration-500 rounded-xl border-4 border-black border-solid object-cover object-center"
  />
  ...
  <div className="absolute inset-0 bg-black bg-opacity-70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col gap-4 justify-center items-center text-white">
    <h1 className="text-4xl font-bold decoration-dashed underline underline-offset-4">
      {item.title}
    </h1>
    ...
    <div className="flex gap-12">
      <div className="block">
        ...
        <p className="font-semibold text-[#ffa700]">Frontend Developer</p>
      </div>
      <div className="block">
