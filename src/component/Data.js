...
import virtualRakhi from '../assets/blogsimage/virtual-rakhi.avif'
import reactHook from '../assets/blogsimage/react-hook-form.avif'
...
const Data = [
  {
    id:'1',
    image:virtualRakhi,
    title:'Crafting a Personalized Virtual Rakhi Card with React: A Digital Twist on Tradition',
    category:'Technical',
    ...
    desc:"In today’s fast-paced world, where physical distances often separate loved ones, technology bridges the gap creatively and meaningfully. One such...",
    link:'https://snehafarkya.hashnode.dev/crafting-a-personalized-virtual-rakhi-card-with-react-a-digital-twist-on-tradition'
  },
  {
    id:'1',
    image:reactHook,
    title:'Simplifying Form Validation in React with React Hook Form: A Real-Life Use Case',
    category:'Technical',
    categoryDesc:"In the vast era of rapid technology development, it is neccessary to stay updated! Read my technical articles here.",
    desc:"In modern web development, handling forms efficiently is crucial, especially regarding validation and managing user input. React Hook Form is a...",
    link:'https://snehafarkya.hashnode.dev/simplifying-form-validation-in-react-with-react-hook-form-a-real-life-use-case'
  },
  {
    id:'1',
    image:contextapi,
